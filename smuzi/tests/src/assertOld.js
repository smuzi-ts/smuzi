...
import {StructValidationException, validationSchema, isStructInstance} from "@smuzi/std/spec";
import {AssertionError} from "node:assert";
import {isEmpty, isFunction, isNone} from "@smuzi/std";

import {getClass} from "@smuzi/std";

const signalOk = new Error('__OK__')
const sendSignalOk = () => { throw signalOk; };
const isSignalOk = actual => Object.is(actual, signalOk);

export const assertOld = {
    //Native
    equal: _assert.equal,
